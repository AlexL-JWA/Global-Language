...
//                            var_dump($the_query->posts);
                        ...
                        <div class="blog-item">
                            <?php if(!empty($my_blog_lup['picture_for_a_brief_description'])) : ?>
                            <img src="<?php  echo $my_blog_lup['picture_for_a_brief_description'];?>" alt="image not found">
                            <?php else :?>
                             <img src="<?php  the_post_thumbnail_url(); ?>" alt="image not found">   
                            <?php endif; ?>
