<?php
/**Template name: docs_translation_page */
get_header();
...
$block_of_the_fourth_1_section = get_field('block_of_the_fourth_1_section', $post_id);
...
<!--                                        <i class="<?php lem_docs_translation($count);?>"></i>-->
        ...
        <?php endif; ?>
        <?php if (isset($block_of_the_fourth_1_section) && !empty($block_of_the_fourth_1_section)): ?>
        <div class="translation">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="descriptions">
                                ...
                                <?php $count = 1; ?>
                                <?php foreach ($block_of_the_fourth_1_section as $block): ?>
                                    <div class="description">
                                        <i class="<?php lem_docs_translation($count);?>"></i>
                                        <h3 class="title"><?php echo $block['title'];?></h3>
                                        <?php echo $block['description'];?>
