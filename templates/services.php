...
$block_of_the_second_section1 = get_field('block_of_the_second_section1', $post_id);
$block_of_the_second_section2 = get_field('block_of_the_second_section2', $post_id);
$block_of_the_second_section3 = get_field('block_of_the_second_section3', $post_id);
...
<section class="services">
    ...
    <div class="categories">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php if($service_page['the_title_of_the_second_section1'] != null){ ?>
                    <h2 class="title"><?php echo $service_page['the_title_of_the_second_section1'];?></h2>
                    <?php }?>
                    <div class="items">
                    <?php if (isset($block_of_the_second_section1) && !empty($block_of_the_second_section1)): ?>
                        <?php foreach ($block_of_the_second_section1 as $block): ?>
                        <div class="item">
                            <div>
                                <a href="<?php echo $block['link'];?>"><img src="<?php echo $block['image'];?>" alt="#"></a>
                                <h3 class="title"><?php echo $block['titlr'];?></h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php if($service_page['the_title_of_the_second_section2'] != null){ ?>
                    <h2 class="title"><?php echo $service_page['the_title_of_the_second_section2'];?></h2>
                    <?php }?>
                    <div class="items">
                    <?php if (isset($block_of_the_second_section2) && !empty($block_of_the_second_section2)): ?>
                        <?php foreach ($block_of_the_second_section2 as $block): ?>
                        <div class="item">
                            <div>
                                <a href="<?php echo $block['link'];?>"><img src="<?php echo $block['image'];?>" alt="#"></a>
                                <h3 class="title"><?php echo $block['titlr'];?></h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <?php if($service_page['the_title_of_the_second_section3'] != null){ ?>
                    <h2 class="title"><?php echo $service_page['the_title_of_the_second_section3'];?></h2>
                    <?php }?>
                    <div class="items">
                    <?php if (isset($block_of_the_second_section3) && !empty($block_of_the_second_section3)): ?>
                        <?php foreach ($block_of_the_second_section3 as $block): ?>
                        <div class="item">
                            <div>
                                <a href="<?php echo $block['link'];?>"><img src="<?php echo $block['image'];?>" alt="#"></a>
                                <h3 class="title"><?php echo $block['titlr'];?></h3>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="descriptions">
                        ...
                        <div class="description">
                            <i class="<?php lem_block_of_the_third_sectionn($count);?>"></i>
